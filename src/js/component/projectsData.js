export const ProjectsData = [
  ...
  },
  {
    ...
    details: {
      fullDescription: {
        en: "Boost A Project is a real estate investment platform designed to connect investors with high-potential projects. The application features a clean and scalable architecture using Next.js with TypeScript for the frontend and Flask for the backend. The admin panel allows full control over published projects, blog articles, investor communication, and data visualization via dashboards. Focused on transparency and professionalism, the system is built for future integration of payment gateways, legal documentation management, and advanced user flows.",
        es: "Boost A Project es una plataforma de inversión inmobiliaria diseñada para conectar a inversores con proyectos de alto potencial. La aplicación cuenta con una arquitectura limpia y escalable usando Next.js con TypeScript en el frontend y Flask en el backend. El panel de administración permite un control total sobre los proyectos publicados, los artículos del blog, la comunicación con inversores y la visualización de datos mediante dashboards. Con foco en la transparencia y profesionalismo, el sistema está preparado para futuras integraciones con pasarelas de pago, gestión de documentación legal y flujos avanzados de usuario.",
      },
      tecnologiasUsadas: {
